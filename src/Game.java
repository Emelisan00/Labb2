...
import java.util.*;
	...
	public class Game {
	    ...
	    public Game() {
		    ...
		    Location Severin = new Severin("Severin", "You have reached the entrence of the dark woods of Severin, but you can't ride further beacuse of the giant rockes that are blocking the way. There is a shovel to your right", "You are back in Severin and the rocks are still blocking your way.");
		    ...
		    Location Field = new Field("Field", "You are standing in the middle of a deserted earthfield.", "You are back at the earthfield.");
