...
public  class Location {
 ...
 public void fixPath(String command, Player player) {
		...
		if (command.equals("north")) {
			...
			if (newPositionNorth.beenHereBefore == false ){
		...
		if (command.equals("east")) {
			...
			if (newPositionEast != null) {
				if (newPositionEast.beenHereBefore == false ){
		...
		if (command.equals("south")) {
			...
			if (newPositionSouth != null) {	
				if (newPositionSouth.beenHereBefore == false ){
		...
		if (command.equals("west")) {
			...
			if (newPositionWest != null) {
				if (newPositionWest.beenHereBefore == false ){
